                        ...
                        @foreach ($categories as $category)
                            <div class="featured-wrap">
                                <div class="featured-img">
                                    <img src="{{ asset('dashboard_asset/photo/category_photo') }}/{{ $category->cat_photo }}" alt="">
                    ...
                    <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="product-wrap">
                            <div class="product-img">
                                <img src="{{ asset('frontend_asset') }}/assets/images/product/1.jpg" alt="">
                    ...
                    <div class="testmonial-active owl-carousel">
                        @for ($i = 0; $i < 3; $i++)
                            <div class="test-items test-items2">
                                ...
                                <div class="test-img2">
                                    <img src="{{ asset('frontend_asset') }}/assets/images/test/1.png" alt="">
                                </div>
                            </div>
                        @endfor
                    </div>
