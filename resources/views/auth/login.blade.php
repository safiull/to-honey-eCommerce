...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('dashboard_asset') }}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-0">
        <a href="{{ url('customer/login') }}" class="text-center" >Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
