<style>
    ...
    <h2 style="text-align: center; font-size: 30px; margin-top: 100px; margin-bottom: 0px; color: teal;">Halal Business point BD</h2>
        ...
        <tbody>
            @foreach ($order_infos as $order_info)
                <tr>
                    ...
                    <td>{{ $order_info->product->product_name }}</td>
                    <td>{{ $order_info->product_quantity }}</td>
                    <td>{{ $order_info->product_price }}</td>
