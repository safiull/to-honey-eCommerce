                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <ul class="d-flex header-contact">
                            ...
                            <li><i class="fa fa-envelope"></i> safiullalam9931@gmail.com</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-12">
                        <ul class="d-flex account_login-area">
                            <li>
                                <a href="javascript:void(0);"><i class="fa fa-user"></i>    @auth
                                        {{ Auth::user()->name }}
                                    @endauth     
                                    @guest
                                        My Account
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 d-none d-lg-block">
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                ...
                                <li>
                                    <a href="javascript:void(0);">Shop ({{ ProductCount() }})<i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown_style">
                    ...
                    <div class="col-md-4 col-lg-2 col-sm-5 col-4">
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                <a href="javascript:void(0);"><i class="flaticon-shop"></i> <span>{{ CartProductCount() }}</span></a>
                                <ul class="cart-wrap dropdown_style">
                                    @php
                                        $subtotal = 0;
                                    @endphp
                                    @foreach (CartProducts() as $cart_item)
                                        <li class="cart-items">
                                            <div class="cart-img">
                                                <img src="{{ asset('dashboard_asset/photo/product_photo') }}/{{ $cart_item->product->product_photo }}" width="70" alt="Not found">
                                            </div>
                                            <div class="cart-content">
                                                ...
                                                <a href="{{ url('delete/cart') }}/{{ $cart_item->id }}"><i class="fa fa-times"></i></a>
                                            </div>
                                        </li>
                                        @php
                                    ...
                                    <li>
                                        <a href="{{ url('go_to_cart') }}" class="btn btn-outline-danger text-light">GO TO CART</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
